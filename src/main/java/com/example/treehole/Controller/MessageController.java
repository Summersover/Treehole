...
import com.example.treehole.Entity.Message;
...
@Controller
public class MessageController implements TreeholeConstant {
    ...
    public String sendLetter(String toName, String content) {
        ...
        if (target == null) {
            return TreeholeUtil.getJsonString(1, "目标用户不存在");
        }
        ...
        return TreeholeUtil.getJsonString(0);
    }
    ...
    public String getNoticeList(Model model) {
        ...
        if (message != null) {
            ...
            String content = HtmlUtils.htmlUnescape(message.getContent()); //取出去除html标签转义字符的内容
